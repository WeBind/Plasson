        ...
        try
         {
            ...
            try {
                if (instance.validateXMLString(xsdPath, xml))
                {
                    ...
                    Consumer expConsumer1 = new Consumer(18, 1000, 100,(float) 1.0, 300, 0);
                    assertEquals(consumer1.toString(), expConsumer1.toString());

                    Consumer expConsumer2 = new Consumer(148, 1000, 100,(float) 1, 300, 0);
         ...
         try
         {
            ...
            try {
                if (instance.validateXMLString(xsdPath, xml))
                {
                    ...
                    Provider expConsumer1 = new Provider(0, 1089, 1000);
                    assertEquals(provider1.toString(), expConsumer1.toString());

                    Provider expConsumer2 = new Provider(5, 19, 109);
